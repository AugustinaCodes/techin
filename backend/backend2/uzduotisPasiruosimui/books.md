...
1. **Autorizacija:**
   ...
   - Registracija (`POST /auth/register`): naujo vartotojo sukūrimas. ** 2 taškas **
...
1. Patalpinkite darbą į Docker Compose projektą.
2. Pateikite kodo github nuorodą teams platformoje, prie užduoties.

3. Ten pat pateikite testavimo aplikacija BRUNO endpointus, išsaugokite tarp projektų failų.

4. Viso galima surinkti 20 taškų, tai atitinka 10 balų.
